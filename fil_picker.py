...
class TestTargetFinder(targetfinder.TargetFinder):
	...
	def your_targetfinder(self, image):
        ...
        # c_fil is the convolution instructions. It gives different weights to different classes. Fil is good, while agg, ice, and carbon are bad, but with varying degrees.
