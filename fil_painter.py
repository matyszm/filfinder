...
if __name__ == '__main__':
    ...
    # parses arguments for database name and directory. Directory is optional as you will get prompt if left empty. db needed to create a new database due to how Qt handles things.
